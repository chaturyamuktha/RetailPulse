Title: Real-Time Retail Intelligence Using DirectQuery and AI Insights

Objective:   To design and deploy a real-time retail intelligence dashboard using Power BI’s DirectQuery mode, enabling instant access to live data from an on-premises SQL Server. The dashboard will leverage advanced DAX, AI-powered forecasting and anomaly detection, and interactive features like slicers, drill-through, and bookmarks to help retail stakeholders make faster, smarter decisions. 

Requirements:    1. SQL Server 2022
                 2. Power BI version: 2.148.1226.0 
